...
*
*******************************************************************************/
extern void spi_initialize_interrupt(void);
...
extern unsigned char uc_receive_spi(void);
extern unsigned int ptr_send_receive_spi(unsigned char* ptr_send_array,unsigned char* ptr_receive_array);
